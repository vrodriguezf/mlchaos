...
__all__ = ['TensorTSMotion', 'ToTensorTSMotion', 'StandardizeNoDecode', 'StandardizeGlobal', 'StandardizeItem',
           'prettify_plot_TensorTSMotion']
...
def plot_top_losses(x:TensorTSMotion, y:TensorCategory, samples, outs, raws, losses, nrows=1, figsize=None, **kwargs):
    ...
    for s,o,r,l,i in zip(samples, outs, raws, losses, range(len(samples))):
        ...
        s[0].show(ctx=ctxs[1 + nchannels*int(i/ncols)][i%ncols], label='x', chs=[1], color='C1', **kwargs)
